...
if __name__ == "__main__":
    ...
    dir = "/home/ekats/scratch/data"
    # dir = args.dir
    # Read the params state
    ########## SET THIS BEFORE RUNNING! ##########
    DEV_MODE = False # args.devmode
    RAG_MODE = False # args.rag_mode
    ...
    if APIKEY.startswith("gsk_"):
        if MODEL.startswith("llama"):
            ...
            print("API - Model mismach. reverting to default (llama3-70b-8192)" )
            client=Groq(api_key=APIKEY)
                            # Here add aditional APIs
    ...
    objective = get_objective(
        ...
        api_key= None if client else APIKEY
    )
    # print(objective)
